(function($) {
    ...
    // Sidebar disable default scroll
    ...
    $(".left-sidebar").hover(
        function() {
            ...
            // Enable left-sidebar scroll
            $('.left-sidebar').css("overflow-y", "scroll");

            $(".navbar-header").addClass("expand-logo");

            // Disable scroll for body and but not hide scroll bar
            ...
            // Disable left-sidebar scroll
           // $('.left-sidebar').css("overflow-y", "hidden");

            $(".navbar-header").removeClass("expand-logo");

            // Enable scroll for body and scroll bar
